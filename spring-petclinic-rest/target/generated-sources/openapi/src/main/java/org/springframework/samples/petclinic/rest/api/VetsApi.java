...
public interface VetsApi {
    ...
    String PATH_DELETE_VET = "/vets/{vetId}";
    /**
    ...
    @RequestMapping(
        ...
        value = VetsApi.PATH_DELETE_VET,
        produces = { "application/json" }
    )
    default ResponseEntity<VetDto> deleteVet(
        @NotNull @Min(value = 0) @Parameter(name = "vetId", description = "The ID of the vet.", required = true, in = ParameterIn.PATH) @PathVariable("vetId") Integer vetId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_GET_VET = "/vets/{vetId}";
    /**
    ...
    String PATH_UPDATE_VET = "/vets/{vetId}";
    /**
