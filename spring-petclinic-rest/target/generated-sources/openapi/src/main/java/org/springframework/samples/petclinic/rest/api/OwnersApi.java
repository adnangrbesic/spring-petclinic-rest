...
public interface OwnersApi {
    ...
    @RequestMapping(
        ...
        value = OwnersApi.PATH_ADD_OWNER,
    ...
    String PATH_ADD_PET_TO_OWNER = "/owners/{ownerId}/pets";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = OwnersApi.PATH_ADD_PET_TO_OWNER,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<PetDto> addPetToOwner(
        @NotNull @Min(value = 0) @Parameter(name = "ownerId", description = "The ID of the pet owner.", required = true, in = ParameterIn.PATH) @PathVariable("ownerId") Integer ownerId,
    ...
    String PATH_ADD_VISIT_TO_OWNER = "/owners/{ownerId}/pets/{petId}/visits";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = OwnersApi.PATH_ADD_VISIT_TO_OWNER,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    ...
    String PATH_DELETE_OWNER = "/owners/{ownerId}";
    /**
    ...
    @RequestMapping(
        ...
        value = OwnersApi.PATH_DELETE_OWNER,
        produces = { "application/json" }
    )
    default ResponseEntity<OwnerDto> deleteOwner(
        @NotNull @Min(value = 0) @Parameter(name = "ownerId", description = "The ID of the owner.", required = true, in = ParameterIn.PATH) @PathVariable("ownerId") Integer ownerId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_GET_OWNER = "/owners/{ownerId}";
    /**
    ...
    @RequestMapping(
        ...
        value = OwnersApi.PATH_GET_OWNER,
        produces = { "application/json" }
    )
    ...
    String PATH_GET_OWNERS_PET = "/owners/{ownerId}/pets/{petId}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = OwnersApi.PATH_GET_OWNERS_PET,
        produces = { "application/json" }
    )
    ...
    String PATH_LIST_OWNERS = "/owners";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = OwnersApi.PATH_LIST_OWNERS,
        produces = { "application/json" }
    )
    default ResponseEntity<List<OwnerDto>> listOwners(
        @Parameter(name = "lastName", description = "Last name.", in = ParameterIn.QUERY) @Valid @RequestParam(value = "lastName", required = false) @Nullable String lastName
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_UPDATE_OWNER = "/owners/{ownerId}";
    /**
    ...
    @RequestMapping(
        ...
        value = OwnersApi.PATH_UPDATE_OWNER,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    ...
    String PATH_UPDATE_OWNERS_PET = "/owners/{ownerId}/pets/{petId}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.PUT,
        value = OwnersApi.PATH_UPDATE_OWNERS_PET,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
