...
public interface SpecialtiesApi {
    ...
    String PATH_ADD_SPECIALTY = "/specialties";
    /**
    ...
    @RequestMapping(
        ...
        value = SpecialtiesApi.PATH_ADD_SPECIALTY,
    ...
    String PATH_DELETE_SPECIALTY = "/specialties/{specialtyId}";
    /**
    ...
    @RequestMapping(
        ...
        value = SpecialtiesApi.PATH_DELETE_SPECIALTY,
        produces = { "application/json" }
    )
    default ResponseEntity<SpecialtyDto> deleteSpecialty(
        @NotNull @Min(value = 0) @Parameter(name = "specialtyId", description = "The ID of the specialty.", required = true, in = ParameterIn.PATH) @PathVariable("specialtyId") Integer specialtyId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_GET_SPECIALTY = "/specialties/{specialtyId}";
    /**
    ...
    @RequestMapping(
        ...
        value = SpecialtiesApi.PATH_GET_SPECIALTY,
        produces = { "application/json" }
    )
    default ResponseEntity<SpecialtyDto> getSpecialty(
        @NotNull @Min(value = 0) @Parameter(name = "specialtyId", description = "The ID of the speciality.", required = true, in = ParameterIn.PATH) @PathVariable("specialtyId") Integer specialtyId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_LIST_SPECIALTIES = "/specialties";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = SpecialtiesApi.PATH_LIST_SPECIALTIES,
        produces = { "application/json" }
    )
    ...
    String PATH_UPDATE_SPECIALTY = "/specialties/{specialtyId}";
    /**
    ...
    @RequestMapping(
        ...
        value = SpecialtiesApi.PATH_UPDATE_SPECIALTY,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
