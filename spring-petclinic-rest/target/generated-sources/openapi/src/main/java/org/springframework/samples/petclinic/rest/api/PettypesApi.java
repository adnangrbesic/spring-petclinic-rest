...
public interface PettypesApi {
    ...
    String PATH_ADD_PET_TYPE = "/pettypes";
    /**
    ...
    @RequestMapping(
        ...
        value = PettypesApi.PATH_ADD_PET_TYPE,
    ...
    String PATH_DELETE_PET_TYPE = "/pettypes/{petTypeId}";
    /**
    ...
    @RequestMapping(
        ...
        value = PettypesApi.PATH_DELETE_PET_TYPE,
        produces = { "application/json" }
    )
    default ResponseEntity<PetTypeDto> deletePetType(
        @NotNull @Min(value = 0) @Parameter(name = "petTypeId", description = "The ID of the pet type.", required = true, in = ParameterIn.PATH) @PathVariable("petTypeId") Integer petTypeId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    String PATH_GET_PET_TYPE = "/pettypes/{petTypeId}";
    /**
    ...
    @RequestMapping(
        ...
        value = PettypesApi.PATH_GET_PET_TYPE,
        produces = { "application/json" }
    )
    ...
    String PATH_LIST_PET_TYPES = "/pettypes";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = PettypesApi.PATH_LIST_PET_TYPES,
        produces = { "application/json" }
    )
    ...
    String PATH_UPDATE_PET_TYPE = "/pettypes/{petTypeId}";
    /**
    ...
    @RequestMapping(
        ...
        value = PettypesApi.PATH_UPDATE_PET_TYPE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
